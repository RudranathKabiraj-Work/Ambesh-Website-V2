...
async function V({ routeId: e, pathVariables: t, localeId: r, collectionItemId: i }) {
      ...
      children: y(R, {
        children: y(N, {
          children: y(P, {
            ...
            collectionUtils: K,
            framerSiteId: q,
            notFoundPage: I(() => import(`./SitesNotFoundPage.js@1.4.sxAGE26t.mjs`)),
            isReducedMotion: void 0,
            localeId: r,
            locales: G,
            preserveQueryParams: void 0,
            siteCanonicalURL: `https://3dservicecarousel.framer.website`,
            EditorBar:
              c === void 0
                ? void 0
                : (() => {
                    ...
                    return I(async () => {
                      c.__framer_editorBarDependencies = {
                        __version: 3,
                        framer: { useCurrentRoute: C, useLocaleInfo: M, useRouter: D },
                        react: {
                          createElement: y,
                          Fragment: o,
                          memo: d,
            ...
            loadSnippetsModule: new z(
              () => import(`./QUkHU6bbv_MIdgGly6fhyvalu0h-y-OJ2dw7dej561Y.CK-Nw7tG.mjs`),
            ),
...
`,
  ...
  try {
    ...
    if (e)
      ...
      if (!r || !i) {
        let e = w(W, decodeURIComponent(location.pathname), !0, G);
        ((r = e.routeId), (i = e.localeId), (a = e.pathVariables));
      }
    }
    let u = V({ routeId: r, localeId: i, pathVariables: a, collectionItemId: s?.collectionItemId });
    c !== void 0 &&
      (async () => {
        let e = W[r],
    ...
    e
      ? (A(`framer-rewrite-breakpoints`, () => {
          (E(o), c.__framer_onRewriteBreakpoints?.(o));
        }),
        (Y ? (e) => e() : l)(() => {
          (O(), j(), v(t, d, { onRecoverableError: n }));
        }))
...
e(() => {
  if (
    ...
    (W = {
      augiA20Il: {
        elements: {},
        page: I(() => import(`./R2ifGy0AYaaNkf-u4gPZWG8Ycn7s_9KANb3Q8v5XN1U.BPhVP8Re.mjs`)),
        path: `/`,
      },
    }),
    (G = [{ code: `en-US`, id: `default`, name: `English`, slug: ``, textDirection: `ltr` }]),
    (K = {}),
    (q = `e357991a0719ae35bbafe059b8a6f739ef50f49e211996de2bba95ec9a6b85dc`),
    (J = typeof document < `u`),
    ...
    J &&
      l(() => {
        v(
          ...
          y(m, {}, y(g(() => import(`./PX9hIOIVM.jPGvDbsB.mjs`)))),
        );
      });
  })();
})();
export { V as getPageRoot };
//# sourceMappingURL=script_main.cZUavPwq.mjs.map

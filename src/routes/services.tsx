...
const faqs = [
  { q: "Who is the Business OS built for?", a: "Founder-led businesses, usually between INR 5 crore and INR 100 crore, where the founder is still the ceiling on growth and systems live mostly in the founder's head." },
  { q: "How long does an engagement take?", a: "A typical Business OS engagement runs across 8 to 12 weeks, with the initial OS installed in the first 4 to 6 weeks and adoption support layered on top." },
  { q: "Do you replace our tools?", a: "Rarely. Most companies already have the tools they need. What is missing is the Operating System that connects them and the workflows that make them useful." },
  { q: "How is AI used inside the Business OS?", a: "AI is installed as leverage inside the workflows your team already runs. It is never a separate track. If AI cannot make a workflow measurably better, we do not force it in." },
  { q: "Do you also do standalone AI training?", a: "Yes. AI Training is a core standalone offer. Many companies start with training and later bring in the full Business OS engagement." },
  { q: "Do you sign NDAs?", a: "Yes. NDAs are standard for any engagement that touches internal systems, workflows or data." },
  { q: "Do you travel internationally?", a: "Yes. Ambesh works with teams across India, UAE and Africa." },
];
        ...
        <div className="container-edit relative">
          <Reveal>
            ...
            <h2 className="mt-4 max-w-3xl text-4xl font-extrabold leading-[1.05] tracking-tighter md:text-6xl">
              Three layers. <span className="text-gradient-brand animate-gradient">One Operating System.</span>
            </h2>
      ...
      <section className="relative overflow-hidden bg-sand py-16">
        ...
        <div className="container-edit relative">
          <Reveal>
            ...
            <h2 className="mt-4 max-w-3xl text-4xl font-extrabold leading-[1.05] tracking-tighter md:text-6xl">
              How an OS engagement <span className="text-gradient-brand animate-gradient">actually runs.</span>
            </h2>
            <p className="mt-6 max-w-2xl text-lg text-ink-muted">
          ...
          <div className="grid gap-8 rounded-3xl custom-theme-card-static p-8 md:grid-cols-12 md:items-center md:gap-12 md:p-12">
            <div className="md:col-span-7">
              ...
              <p className="mt-4 text-base text-ink-soft">
                AI Training is a standalone offer. Leadership workshops, department workshops, and multi-day team bootcamps. Many companies start here and later bring in the full Business OS engagement.
              </p>
            </div>

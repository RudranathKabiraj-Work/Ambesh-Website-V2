...
export default function HomePageSections() {
  ...
  return (
    <>
          ...
          <div className="grid gap-12 md:grid-cols-12 md:items-start">
            ...
            <Reveal delay={120} className="md:col-span-7">
              ...
              <ul className="mt-8 grid gap-3 sm:grid-cols-2">
                {problems.map((p) => (
                  <li key={p} className="flex items-start gap-2.5 rounded-[20px] custom-theme-card-static pointer-events-none p-4 text-sm text-ink-soft">
      ...
      <section className="relative overflow-hidden bg-canvas py-16 md:py-24">
        <div className="container-edit relative">
          ...
          <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
            {[
              { stage: "Stage 01", label: "Eliminate", desc: "Remove work that doesn't create value.", color: "to-amber-500/15" },
              { stage: "Stage 02", label: "Automate", desc: "Use AI only after the process is clear.", color: "to-blue-500/15" },
              { stage: "Stage 03", label: "Streamline", desc: "Connect people, processes, and technology.", color: "to-emerald-500/15" },
              { stage: "Stage 04", label: "Execute", desc: "Turn ideas into consistent business results.", color: "to-violet-500/15" },
            ].map(({ stage, label, desc, color }, i) => (
              <Reveal key={label} delay={i * 80}>
                <div className={`group relative flex h-full flex-col justify-between overflow-hidden rounded-[20px] border border-ink/15 bg-gradient-to-r from-sand/90 via-sand/35 ${color} backdrop-blur-md p-6 transition-all duration-500 ease-out -translate-y-1.5 shadow-lift hover:translate-y-0 hover:scale-100 hover:border-ink/35 hover:bg-none hover:bg-canvas hover:shadow-none`}>
                  ...
                  <div>
                    <span className="font-mono text-[0.65rem] font-bold uppercase tracking-[0.15em] text-accent animate-gradient text-gradient-brand">{stage}</span>
      ...
      <section id="beliefs" className="relative overflow-hidden bg-canvas py-12 md:py-16">
        <div className="container-edit relative">
          ...
          <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-2">
            {[
              {
                n: "01", icon: Workflow, color: "to-orange-500/15",
              ...
              {
                n: "02", icon: Sparkles, color: "to-purple-500/15",
              ...
              {
                n: "03", icon: Compass, color: "to-teal-500/15",
              ...
              {
                n: "04", icon: Wrench, color: "to-indigo-500/15",
      ...
      <section id="work" className="relative overflow-hidden bg-canvas bg-premium-side-gradient py-16 md:py-24">
        <div className="container-edit relative">
          ...
          <div className="mt-12 grid gap-4 md:grid-cols-2">
            {[
              {
                n: "01", title: "Landmark Group, Dubai", eyebrow: "Practical AI & automation training",
              ...
              {
                n: "02", title: "TATA Digital", eyebrow: "AI Consulting & Training",
              ...
              {
                n: "03", title: "NICASA of NIRC of ICAI", eyebrow: "AI training for finance professionals",
              ...
              {
                n: "04", title: "Ministry of Finance, Tanzania", eyebrow: "AI awareness & practical use",
              ...
              <Reveal key={n} delay={i * 80}>
                <div className={`group relative flex h-full flex-col justify-between overflow-hidden rounded-[20px] border border-ink/15 bg-gradient-to-r from-sand/90 via-sand/35 ${color} backdrop-blur-md p-7 transition-all duration-500 ease-out -translate-y-1.5 shadow-lift hover:translate-y-0 hover:scale-100 hover:border-ink/35 hover:bg-none hover:bg-canvas hover:shadow-none md:p-8`}>
                  ...
                  <div>
                    ...
                    <p className="mt-2 inline-flex items-center gap-1.5 border-l-2 pl-2.5 font-mono text-[0.7rem] font-semibold uppercase tracking-wider text-ink-muted animate-gradient text-gradient-brand">{eyebrow}</p>
        ...
        <div className="container-edit relative">
          <div className="grid gap-6 md:grid-cols-12 md:items-start md:gap-12 mb-12">
            <Reveal className="md:col-span-6">
              ...
              <h2 className="mt-4 font-display text-[2.2rem] font-extrabold leading-[1.1] tracking-[-0.03em] sm:text-4xl md:text-5xl text-ink">
                I do not only advise. <span className="font-serif italic font-medium text-gradient-brand animate-gradient">I build.</span>
              </h2>
            </Reveal>
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {[
              {
                n: "01 / Product", title: "BDA Technologies", eyebrow: "Business systems & automation",
              ...
              {
                n: "02 / Product", title: "LinkAssist", eyebrow: "AI support for LinkedIn authority",
              ...
              {
                n: "03 / Platform", title: "Automation School", eyebrow: "AI Training For Professionals",
              ...
              <Reveal key={n} delay={i * 80}>
                <div className={`group relative flex h-full flex-col justify-between overflow-hidden rounded-[20px] border border-ink/15 bg-gradient-to-r from-sand/90 via-sand/35 ${color} backdrop-blur-md p-7 transition-all duration-500 ease-out -translate-y-1.5 shadow-lift hover:translate-y-0 hover:scale-100 hover:border-ink/35 hover:bg-none hover:bg-canvas hover:shadow-none md:p-8`}>
                  ...
                  <div>
                    ...
                    <h3 className="mt-3 font-display text-xl font-extrabold tracking-tight text-ink md:text-2xl">{title}</h3>
                    <p className="mt-2 inline-flex items-center gap-1.5 border-l-2 pl-2.5 font-mono text-[0.7rem] font-semibold uppercase tracking-wider text-ink-muted">{eyebrow}</p>
          ...
          <div className="grid gap-12 md:grid-cols-12 md:gap-16">
            <Reveal className="md:col-span-5">
              ...
              <h2 className="mt-4 font-display text-4xl font-extrabold tracking-[-0.03em] md:text-5xl text-ink">
                Meet <span className="font-serif italic font-medium text-gradient-brand animate-gradient">Ambesh.</span>
              </h2>
            </Reveal>
            <Reveal delay={120} className="md:col-span-7">
              ...
              <div className="space-y-3.5 text-[15px] md:text-base leading-[1.6] text-ink-soft">
                ...
                <blockquote className="border-l-2 pl-4 font-serif text-lg md:text-xl italic leading-snug text-ink my-3" style={{ borderColor: "var(--accent)" }}>
                  &ldquo;The problem was often not a lack of technology. The problem was the gap between people, process and technology.&rdquo;
                </blockquote>
                <p className="text-ink">Today, I help businesses close that gap. I help founders build businesses that are simpler to run and easier to grow.</p>
              </div>
              <div className="mt-8">
                <Link
                  to="/about"
      ...
      <section className="relative overflow-hidden bg-canvas py-16 md:py-24">
        <div className="container-edit relative">
          <div className="grid gap-12 rounded-[20px] border border-rule bg-canvas p-8 md:grid-cols-12 md:items-center md:gap-16 md:p-14 shadow-sm">
            <Reveal className="md:col-span-5">
            ...
            <Reveal delay={120} className="md:col-span-7">
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                <a href="https://www.amazon.in/dp/B0CLKZK6JS?ref_=cm_sw_r_cp_ud_dp_YJBSASGYYGPGJ42PBTK2" target="_blank" rel="noopener noreferrer" className="btn-premium group inline-flex h-12 items-center gap-2 rounded-full px-6 text-sm font-semibold">
        ...
        <div className="container-edit relative py-16 md:py-24">
          <Reveal>
            ...
            <h2 className="mt-6 max-w-4xl font-display text-4xl font-extrabold leading-[1.1] tracking-[-0.03em] text-canvas sm:text-5xl md:text-7xl">
              Ready to Build a Business <span className="font-serif italic font-medium text-gradient-brand animate-gradient">That Runs Better?</span>
            </h2>
            ...
            <div className="mt-10 flex flex-wrap gap-3">
              ...
              <a href="https://wa.me/918929465115?text=Hi%20Ambesh%2C%20I%20want%20to%20book%20a%20strategy%20call%20for%20my%20company.%20Please%20share%20the%20next%20steps." target="_blank" rel="noopener noreferrer" className="inline-flex h-14 items-center gap-2 rounded-full border border-canvas/20 px-8 text-base font-semibold text-canvas transition-all hover:bg-canvas/10">
                WhatsApp Ambesh
              </a>
            </div>
